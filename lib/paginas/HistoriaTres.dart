...
class PageHistoriaTres extends StatefulWidget {
  @override
  _PageHistoriaTresState createState() => _PageHistoriaTresState();
}

class _PageHistoriaTresState extends State<PageHistoriaTres> {
  @override
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          i == 4
                          ?Image(
                            image: AssetImage('assets/img/ilustra_placeholder.png'),
                            width: MediaQuery.of(context).size.width,
                          )
                          :Text(
                            '${texts[position]}',
